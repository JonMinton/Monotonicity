...
# Toy example:
tiff("figures/alt/fig_01.tiff", 300,300) 
toy_data <- data.frame(
...
tiff("figures/alt/fig_02.tiff", 500, 500)
...
tiff("figures/alt/fig_03.tiff", 1100,1100) 
...
tiff("figures/alt/fig_04.tiff", 1200, 800)
...
tiff("figures/alt/fig_05.tiff", 1200, 800)
...
# difference
tiff("figures/alt/fig_06.tiff", 1200, 800)
...
tiff("figures/alt/fig_07.tiff", 1200, 800)
